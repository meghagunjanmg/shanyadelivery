...
var user;
const NextDaysOrders  = ({navigation,route}) => 
{
  ...
  const readItemFromStorage = async () => {
    ...
    user = item12[0];
    console.log(user+item12[1]);
    
    callApiData()
  };
  const callApiData = ()=>{
     
   fetch("https://shanya.ca/admin/api/driver/ordersfornextday", {
    "method": "POST",
    headers: {
    ...
    <FlatList
         ...
         return(
             ...
             <View style={{flexDirection:"row",borderBottomColor:"grey"}}>
                  ...
                  <TouchableOpacity 
                    onPress={() => 
                      fetch("https://shanya.ca/admin/api/driver/out_for_delivery", {
                        "method": "POST",
                        headers: {
                           Accept: 'application/json',
                          'Content-Type': 'application/json'
                 ...
                 style={{backgroundColor:"#238A02",width: "48%",padding:10,borderRadius:50,alignItems:"center",marginRight:10}}>
