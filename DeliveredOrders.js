...
import { Linking,Button,Text, View,StyleSheet,FlatList,TouchableOpacity,Image} from 'react-native'
import { useAsyncStorage } from '@react-native-async-storage/async-storage';
import { Card} from 'react-native-elements'

var user;
const DeliveredOrders  = ({navigation,route}) => 
{  
  ...
  const readItemFromStorage = async () => {
   ...
   fetch("https://shanya.ca/admin/api/driver/completed_orders", {
    "method": "POST",
    headers: {
